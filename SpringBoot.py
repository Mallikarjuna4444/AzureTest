...
r = requests.get('https://dev.azure.com/{0}/SpringBoot-Sample/_apis/git/repositories/06ef6858-e62d-4f76-89a8-2b77bd1791b8/commits?api-version=6.0'.format(org_name))
d = r.json()
count = d["count"]

r = requests.get('https://dev.azure.com/{0}/SpringBoot-Sample/_apis/git/repositories/06ef6858-e62d-4f76-89a8-2b77bd1791b8/pullrequests?api-version=6.0'.format(org_name))
d = r.json()
pull_count = d["count"]

r1 = requests.get("https://dev.azure.com/{0}/SpringBoot-Sample/_apis/build/builds?api-version=6.0".format(org_name))
d1=r1.json()
fcount=0
no_builds = d1["count"]
...
r2=requests.get("https://dev.azure.com/{0}/SpringBoot-Sample/_apis/build/builds?api-version=6.0".format(org_name))
d2=r2.json()["value"]
for value in d2:
...
summary_date = "2020-10-15T00:00:00Z"
...
try:
    ...
    cursor.execute("INSERT INTO azure(Reported_Date,Org_name,project_name,branch,summary_date,No_commits,no_builds,avg_build_time,Build_succeeded,Build_failed,build_suc_per,No_of_commiters,pull_requests) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(Reported_Date,org_name,
