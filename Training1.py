...
r3 = requests.get('https://dev.azure.com/{0}/Training1/_apis/git/repositories/3f9dc510-df0b-4cdb-bc4f-e5a4b37e6c93/commits?api-version=6.0'.format(org_name))
d3 = r3.json()
count = d3["count"]

r = requests.get('https://dev.azure.com/{0}/Training1/_apis/git/repositories/3f9dc510-df0b-4cdb-bc4f-e5a4b37e6c93/pullrequests?api-version=6.0'.format(org_name))
d = r.json()
pull_count = d["count"]

r1 = requests.get("https://dev.azure.com/{0}/Training1/_apis/build/builds?api-version=6.0".format(org_name))
d1=r1.json()
fcount=0
no_builds = d1["count"]
i=0
...
r2=requests.get("https://dev.azure.com/{0}/Training1/_apis/build/builds?api-version=6.0".format(org_name))
d2=r2.json()["value"]
for value in d2:
...
summary_date = "2020-10-18T00:00:00Z"
